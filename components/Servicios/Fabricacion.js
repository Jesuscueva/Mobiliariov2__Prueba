...
const Fabricacion = () => {
    const contenedorFabricacion = document.createElement("div")
    contenedorFabricacion.innerHTML = `
    <div class="section__Servicios section__primary">
    <div class="wrapper_title_servicios">
        <h2 class="title_servicios">Fabricacion</h2>
        <div class="line"></div>
    </div>
